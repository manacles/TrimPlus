...
public class SideIndexBar extends View {
    ...
    private void init(Context context) {
        ...
        float size = context.getResources().getDimension(R.dimen.thirteensp);
        int color = Color.parseColor("#999999");
        int touchedColor = Color.parseColor("#333333");
        ...
        mTouchedPaint.setTextSize(size);
        mTouchedPaint.setColor(touchedColor);
    }
